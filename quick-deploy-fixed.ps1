...
Show-Command "1. Subir codigo a GitHub:" "git add . && git commit -m 'Update bot' && git push origin main"
...
Write-Host ""
Write-Host "⚙️  Comandos utiles en VPS:" -ForegroundColor Cyan
